...
That social dimension - the shared space, the conversation, the connections that formed around a row of glowing screens - is something many people genuinely miss about the era. It's worth noting that this quality is part of what [modern home arcade machines](/en/home) are designed to bring back: not just the games themselves, but the reason people gathered around them in the first place.
...
- Computer Space (1971) credited as first mass-produced coin-operated arcade video game - some sources cite Galaxy Game or other predecessors
- Nolan Bushnell and Ted Dabney identified as co-creators of Computer Space
- Pong prototype installed at Andy Capp's Tavern in Sunnyvale, CA in 1972, and the coin-overflow breakdown story
- Space Invaders (1978) contributing to a 100-yen coin shortage in Japan - widely repeated but historically debated
- US arcade industry generating more revenue than film and recorded music combined by 1982 - figures vary significantly across sources
- Golden age of arcade video games dated 1978-1983 - some sources extend this to 1984 or 1986
- Pac-Man as one of the highest-grossing arcade games ever - specific lifetime revenue figures omitted due to source variation
- Toru Iwatani's pizza-slice inspiration for Pac-Man's character design
- Iwatani's motivation to create a game with broader appeal beyond space shooters
- Donkey Kong character originally named Jumpman, later renamed Mario
- Shigeru Miyamoto as designer of Donkey Kong
- Ms. Pac-Man originating as unauthorized hack 'Crazy Otto' created by MIT graduates
- Midway licensing Crazy Otto officially rather than pursuing legal action
- Dragon's Lair (1983) using LaserDisc technology with Don Bluth animation
- Dragon's Lair costing fifty cents per play (double the standard quarter)
- Don Bluth described as former Disney animator
- Warren Robinett embedding his name in Adventure (1980) on Atari 2600
- Pac-Man level 256 kill screen caused by software overflow bug producing garbled right half of maze
- Dave Theurer reportedly having nightmares about nuclear war while developing Missile Command
- Missile Command's ending as a deliberate artistic choice with no victory condition
- Pac-Man Fever by Buckner and Garcia reaching Billboard charts in 1982
- Hanna-Barbera producing the Pac-Man animated television series
- Pac-Man licensed merchandise including lunchboxes, bedsheets, and breakfast cereal within two years of release
- Tron (1982), WarGames (1983), and The Last Starfighter (1984) release dates
- Nintendo Entertainment System as a factor in drawing players from arcades in mid-1980s

## Open TODOs for Human Review

- All 25 historical facts must be independently verified against reliable sources before publishing - the claims_to_verify list above covers each specific assertion
- Revenue and earnings claims (fact 5 and fact 6) deliberately use hedging language ('reportedly', 'vary by source') but specific figures should be confirmed or the hedging retained
- The 100-yen coin shortage claim (fact 3) is widely disputed - editorial team should decide whether to retain with current hedging or remove
- Consider adding source citations or a 'Sources' section for key historical claims if the publication format supports it
- JVL company history and E-E-A-T authority signals could strengthen the closing section if business confirms founding date, years in business, or commercial arcade industry involvement
- Specific game titles included in the Echo Home's 149 built-in games are not confirmed in the knowledge base - if confirmed, the closing section could reference specific classics mentioned in the article as being playable on the machine
- Whether the Echo Home supports two-player simultaneous play is not confirmed - if confirmed, this would strengthen the social-play angle in the closing section
- The Ms. Pac-Man/Crazy Otto origin story (fact 9) has nuances that vary across sources - verify the MIT connection specifically
- Consider whether the article needs an author byline or E-E-A-T-supporting author bio for publication